...
const UserSettingsPage = () => {
  ...
  return (
    <div className="min-h-screen p-8 bg-background dark:bg-background-dark">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              {isEditing.phone ? (
                ...
                <button
                  onClick={() => {
                    setFormData({ ...formData, newPhone: userData.phone });
              ...
              <div className="flex items-center gap-2">
                ...
                {isEditing.contact ? (
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, newTelegram: e.target.value })
                    }
                    className="ml-2 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div className="flex items-center gap-2">
                ...
                {isEditing.contact ? (
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, newWhatsapp: e.target.value })
                    }
                    className="ml-2 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-primary"
