...
const ContentEditModal = ({ addingContent, setAddingContent, setIsAddingContent }: { addingContent: any, setAddingContent: any, setIsAddingContent: React.Dispatch<React.SetStateAction<boolean>> }) => {    const { setCourseList } = useCourseActions();
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setContentDetails({ ...contentDetails, name: e.target.value })}
                                />
                            </div>
